...
package com.android.example.cameraxbasic.camera2basic
        ...
        return try {
            ...
            if (event.pointerCount == 2) { //Multi touch.
                ...
                if (fingerSpacing != 0f) {
                    ...
                    val ratio: Float =
                        1f / zoomLevel //This ratio is the ratio of cropped Rect to Camera's original(Maximum) Rect
                    //croppedWidth and croppedHeight are the pixels cropped away, not pixels after cropped
                    val croppedWidth = rect.width() - (rect.width().toFloat() * ratio).roundToInt()
                    val croppedHeight = rect.height() - (rect.height()
                        .toFloat() * ratio).roundToInt()
